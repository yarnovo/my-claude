...
使用 Task 工具调用 `xlsx-validator` subagent 进行验证：

- **subagent_type**: `xlsx-validator`
- **description**: `验证 xlsx 转换结果`
...
验证器会对比 sheets/ 截图 + program-output.md 与 content.md，检查内容一致性和完整性。
